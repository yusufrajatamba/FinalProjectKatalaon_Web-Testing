...
WebUI.setText(findTestObject('KOTAKOKI_Project/Checkout/checkout01/Page_Checkout/first_name'), 'Raya')

WebUI.setText(findTestObject('Object Repository/KOTAKOKI_Project/Checkout/checkout01/Page_Checkout/last_name'), 'Nugraha')

WebUI.setText(findTestObject('Object Repository/KOTAKOKI_Project/Checkout/checkout01/Page_Checkout/company'), 'KAMUAKU')

WebUI.click(findTestObject('Object Repository/KOTAKOKI_Project/Checkout/checkout01/Page_Checkout/Indonesia'))

WebUI.setText(findTestObject('Object Repository/KOTAKOKI_Project/Checkout/checkout01/Page_Checkout/address'), 'BSD City')

WebUI.setText(findTestObject('Object Repository/KOTAKOKI_Project/Checkout/checkout01/Page_Checkout/address_2'), 'No B3/40')

WebUI.setText(findTestObject('Object Repository/KOTAKOKI_Project/Checkout/checkout01/Page_Checkout/city'), 'Tangerang')
...
WebUI.setText(findTestObject('Object Repository/KOTAKOKI_Project/Checkout/checkout01/Page_Checkout/phone'), '082274532251')
